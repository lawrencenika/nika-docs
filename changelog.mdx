...
<Update label="September 22, 2025" description="v0.5.12">
  ...
  - **Download Form Integration**: Implemented download forms with proper API integration to collect user data and notify sales team
  - **Notebook Export**: Added export functionality for notebooks (requested by Earthbanc team)
  ...
  ![Enhanced User Experience & CTA Features](/images/changelog/2025-09-22.jpg)
</Update>
