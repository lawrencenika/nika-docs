...
Learn how to create a new map in NikaCoMap, customize basemaps, and set up your initial view. Everything gets persisted automatically, so your map will look exactly the same when you reopen it.

## Step 1: Access NikaCoMap
...
![NikaCoMap Interface](/guides/become-map-expert/create-your-first-map-2.jpg)
...
- **Layer Limits**: Theoretically NikaCoMap can load large vector and raster 
- **Auto Saving**: NikaCoMap will auto save your changes, no more worry of data loss
