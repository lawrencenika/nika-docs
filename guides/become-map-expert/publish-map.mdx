---
title: "Publish a Map (with Access Control)"
description: "Learn how to publish your map with team-only, public or password-protected access, including thumbnail generation and collaboration features"
---

import { ContactCTACard } from '/snippets/contact-cta-card.mdx';

Learn how to publish your NikaCoMap for team-only, public, or password-protected sharing. You can publish maps with different names, generate thumbnails using AI, and control access settings.
...
- **Public**: Anyone from public can discover and access the map. All public content can be found at [Nika Hub](https://planet.nika.eco/en/hub)
