...
- **Public**: Make the map publicly accessible to everyone. All team published content can be found at [Nika Gallery](https://planet.nika.eco/en/gallery)
...
- **Public Gallery**: If published publicly, the map appears in the NikaGallery
...
- **Gallery Listing**: Map appears in the [public map gallery](https://planet.nika.eco/gallery/maps)
