...
<a href="https://github.com/NikaGeospatial/geoengine/releases/download/docs-downloads/sg_pgpt_gen.R" download>Download the starter script</a> and save it in an isolated folder somewhere on your machine — your home directory or Desktop works fine.
