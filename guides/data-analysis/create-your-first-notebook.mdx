...
2. **Run Code**: Learn about [Running Code in Notebook](/guides/data-analysis/run-code-in-notebook)
3. **Use Libraries**: Explore [Supported Python Libraries](/guides/data-analysis/supported-python-libraries)
4. **Publish**: [Publish Your Notebook](/guides/data-analysis/publish-notebook) to share with others
