...
### Visibility Settings
- **Team Only**: Restrict access to team members only. All team published content can be found at [Team Gallery](https://planet.nika.eco/en/dashboard/team-gallery) if you are already signed in
- **Public**: Make the notebook publicly accessible to everyone. All team published content can be found at [Nika Gallery](https://planet.nika.eco/en/gallery)
...
- **Public Gallery**: If published publicly, the notebook appears in the NikaGallery
...
- **Gallery Listing**: Notebook appears in the [public notebook gallery](https://planet.nika.eco/en/gallery/notebooks)
