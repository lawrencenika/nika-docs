---
title: "Publish a Notebook (with Access Control)"
...
- **Public**: Anyone from public can discover and access the notebook. All public content can be found at [Nika Hub](https://planet.nika.eco/en/hub)
- **Password Protected**: Anyone with the link can access with password. Share the link and password with specific users
- **Restricted (Team Only)**: Only people from your organization can discover and access. All team published content can be found at [Team Hub](https://planet.nika.eco/en/dashboard/team-hub) if you are already signed in
