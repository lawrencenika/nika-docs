...
If you'd prefer to let an AI agent handle the setup for you, see [Using AI Agents](/guides/geoengine/using-ai-agents).
...
If your script does not already have an argument parser, add one using Python's `argparse` or R's `optparse`. The AI agent skill `write-argparse` can do this for you automatically — see [Using AI Agents](/guides/geoengine/using-ai-agents).
...
Refer to the [Versioning documentation](/guides/geoengine/versioning) for more information on versioning your workers, and the
...
- [Running Workers in ArcGIS Pro & QGIS](/guides/geoengine/running-in-gis) — find and use your worker directly in your GIS software
- [Debugging & Troubleshooting](/guides/geoengine/debugging) — inspect workers, read logs, and fix build issues
- [Using AI Agents](/guides/geoengine/using-ai-agents) — let an AI agent handle the full setup from a single prompt
