...
<Update label="May 25, 2026" description="v0.5.33">
  ## Remote Job Execution from Notebooks

### New Features

- **Submit Runs with Dedicated Compute**: Delegate any Python function on a separate GPU or CPU machine directly from NikaNotebook using the NIKA Python SDK. The notebook stays live while jobs execute in the background — no blocking, no waiting. Perfect for distributed ML or ETL runs.
