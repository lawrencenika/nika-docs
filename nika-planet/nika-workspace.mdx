...
![NikaWorkspace Interface](/nika-planet/nika-workspace.jpg)
...
- **NikaDashboard**: Drag your file or database or map to create an interactive dashboard for operation and presentation
