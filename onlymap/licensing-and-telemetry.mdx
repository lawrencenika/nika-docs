...
- A limit never breaks the map. The layer over the limit does not render, and the validation stream names the exact limit and how to lift it.
- The limits are the same everywhere, including localhost. Development behavior always matches production.
