...
### Data Processing
- **NikaCoNotebook**: Import data from CSV, GeoJSON, Shapefiles, and more to Nika's collaborative python notebook to run analysis on with GDAL pre-installed for you
- **NikaDBMS**: Perform spatial SQL query with connected database or Nika managed DuckDB instances

### Visualization
- **NikaCoMap**: Create dynamic, interactive maps with multiple layers
...
- **NikaCoMap**: Create a powerful map that supports both vector, raster and jpeg layers natively
...
- **NikaCoNotebook**: Use collaborative Python notebooks for advanced geospatial analysis
